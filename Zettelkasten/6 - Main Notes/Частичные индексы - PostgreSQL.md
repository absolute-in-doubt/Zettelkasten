...
Частичный индекс (partial index) создаётся только для строк, удовлетворяющих условию WHERE, что экономит место и ускоряет запросы по редким значениям.
...
----
#### [[Частичные индексы - PostgreSQL - Flashcards|Link to flashcards]]
