...
> [!warning]
> В Postgres нет кластерных индексов
...
Q: Какие типы индексов по способу хранения данных есть в Postgres?
A: Только некластерные. Все данные хранятся только в heap.
<!--ID: 1771079318650-->
