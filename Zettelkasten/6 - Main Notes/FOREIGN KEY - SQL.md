...
> [!note] 
> При вставке значений в Child таблицу (содержащую FOREIGN KEY), если соответствующего значения поля FOREIGN KEY нет в Parent таблице -> error, значение не вставляется.
> ```sql
...
> [!note] **Обобщение**
> Все эти правила триггерятся при изменении/удалении записи Parent таблицы (чей id мы храним)
