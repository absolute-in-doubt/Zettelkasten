...
Также, он генерирует класс-обработчик вопроса и ответа (в данном случае `GreetingServiceGrpc` ). В это мклассе определено всё, кроме самого метода обработки запроса. 
