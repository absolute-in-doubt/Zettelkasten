...
1.  BeanDefinitionReader считывает всё из XML и кладёт все декларации бинов в map.  В этой map у нас ID бина соответствует его декларации, в которую входит:
...
2.  Когда BeanDefinitions созданы, BeanFactory начинает по ним работать:
...
3. Включается BeanPostProcessor. Он позволяет настраивать наши бины до того, как они попали в контейнер. [[Про использование BeanPostProcessor - Spring|Про использование BeanPostProcessor]]. У этого интерфейса есть два метода:
