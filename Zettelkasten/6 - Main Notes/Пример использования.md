...
> [!note] 
> К каждому полю можно применять сразу несколько аннотаций
> 
...
```
Он автоматически подтягивает Jakarta Validation API interfaces. Явно импортировать так:
```xml
<dependency>  
