...
В нашем случае такой индекс улучшит скорость поиска только если ищем по ~={cyan}last_name=~, ~={cyan}first_name=~ в том порядке, в котором они указаны в индексе.

Можно сделать несколько индексов и указать в них те же колонки, но в другом порядке.
