...
Для различных типов данных, отображающих время использовалась устаревшая аннотация ~={purple}@Temporal(`TemporalType tempType`)=~, где аргументами могут быть:
- TemporalType.TIME
...
Сейчас необходимость в такой аннотации отпала, т.к. классы из `java.time` корректно автоматически преобразовываются в представление в БД.


----
#### [[Entity- JPA - Flashcards|Link to flashcards]]
