...
public class MySpringMVCDispatcherServletInitializer extends AbstractAnnotationConfigDispatcherServletInitializer {  
    ...
    protected Class<?>[] getServletConfigClasses() {  
        return new Class[] {SpringConfig.class};  //возвращаем класс конфигурации DispatcherServlet - по сути класс конфигурации ApplicationContext, тот, что с аннотацией @Configuration
    }  
...
- [[Регистрация фильтров в FilterChain - Spring#3. В классе конфигурации DispatcherServlet|Регистрация фильтров в конфигурации DispatcherServlet]]